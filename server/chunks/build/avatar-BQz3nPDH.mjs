...
import { b as buildProps, j as warning_filled_default, k as circle_check_default, l as circle_close_default, n as check_default, f as close_default, E as ElIcon, w as withInstall, i as definePropType, o as document_default, z as zoom_in_default, q as delete_default, m as mutable, _ as _export_sfc$1, r as useVModel, s as isNil } from './base-TFdoAnCk.mjs';
...
import { u as useLocale, i as isEqual } from './index-BQtHQPwO.mjs';
import { u as useFormDisabled, E as ElMessage } from './el-message-arfW-tYb.mjs';
import { e as entriesOf, b as baseClone } from './objects-B0Wm0PUj.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const handleAvatarSuccess = (res, file) => {
      useStore.setUserInfo({ ...useStore.userInfo, avatar: res.data.avatar });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="avatar" data-v-7fcef216>`);
      _push(ssrRenderComponent(_component_el_avatar, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} data-v-7fcef216${_scopeId}>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_el_upload, {
        ...
        action: "https://www.nyknow.com/api/user/",
...
const avatar = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7fcef216"]]);

export { avatar as default };
//# sourceMappingURL=avatar-BQz3nPDH.mjs.map
