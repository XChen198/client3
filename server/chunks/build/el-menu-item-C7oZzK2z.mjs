import { defineComponent, openBlock, createBlock, Transition, mergeProps, unref, toHandlers, withCtx, renderSlot, getCurrentInstance, computed, inject, ref, reactive, watch, provide, h, Fragment, withDirectives, vShow, watchEffect, toRef, nextTick, resolveComponent, createElementBlock, normalizeClass, createElementVNode, createTextVNode, toDisplayString } from 'vue';
import { b as buildProps, v as iconPropType, x as arrow_down_default, e as arrow_right_default, E as ElIcon, i as definePropType, m as mutable, y as more_default, u as useResizeObserver, w as withInstall, h as withNoopInstall, _ as _export_sfc, A as addClass, B as removeClass, C as hasClass, D as useTimeoutFn, s as isNil } from './base-TFdoAnCk.mjs';
import { a as useNamespace, t as throwError, b as isString_1, k as isObject_1 } from './server.mjs';
import { a as ElTooltip, C as ClickOutside } from './el-popper-CBVVU3Ed.mjs';
import { T as TinyColor } from './index-CUqN8X7N.mjs';
import { f as flattedChildren } from './vnode-DGZHcxjK.mjs';
    ...
    return () => {
      ...
      const titleTag = [
        ...
        h(ElIcon, {
          ...
          default: () => isString_1(subMenuTitleIcon.value) ? h(instance.appContext.components[subMenuTitleIcon.value]) : h(subMenuTitleIcon.value)
        })
      ];
...
const menuEmits = {
  ...
  select: (index, indexPath, item, routerResult) => isString_1(index) && checkIndexPath(indexPath) && isObject_1(item) && (routerResult === void 0 || routerResult instanceof Promise)
};
...
export { ElMenu as E, ElSubMenu as a, ElMenuItem as b };
//# sourceMappingURL=el-menu-item-C7oZzK2z.mjs.map
