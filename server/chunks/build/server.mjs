...
var O = (i, o2, a2) => (fi(i, o2, "read from private field"), o2.get(i)), be = (i, o2, a2) => {
  if (o2.has(i))
...
const mr = Symbol.toStringTag, yi = n((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Qs = n((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Ys = n((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a2 } = await import('./multipart-parser-0pQXYM-i.mjs');
...
const unhead_tbuGyTQ82E = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-m1j0S_qV.mjs').then((m) => m.default || m),
    children: [
      {
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./admin-M1aqEUJ6.mjs').then((m) => m.default || m)
      },
      {
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./avatar-BQz3nPDH.mjs').then((m) => m.default || m)
      },
      {
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./info-9Yhjd3Pi.mjs').then((m) => m.default || m)
      },
      {
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./publish-DitOSE5_.mjs').then((m) => m.default || m)
      },
      {
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./published-W1ZzpN7-.mjs').then((m) => m.default || m)
      }
    ]
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-CnJjR_Oi.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-XjklMx1X.mjs').then((m) => m.default || m)
  },
  {
    name: "post-id",
    path: "/post/:id()",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_id_-CN8-HfMf.mjs').then((m) => m.default || m)
  },
  {
    name: "signup",
    path: "/signup",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-DRroS5ho.mjs').then((m) => m.default || m)
  }
];
...
const revive_payload_server_fbIbtT4kJp = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  ...
  plugin$1,
  plugin,
  revive_payload_server_fbIbtT4kJp,
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useSeoMeta({
      title: "纽约华人",
      description: "NYKnow 是一个致力于为纽约地区的华人提供交流和分享的在线论坛。我们致力于打造一个温馨、开放的社区，为纽约的华人朋友们提供一个交流互动的平台。在这里，您可以分享关于生活、工作、学习以及在纽约的种种经验和见解，与他人交流、互助，共同成长。无论您是纽约的新移民、学生、工作者，还是对纽约生活充满好奇的朋友。",
      keywords: "纽约，华人，在线论坛，社区交流，生活经验，工作经验，学习经验，新移民，纽约生活，美国华人"
    });
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DQdTFSMB.mjs').then((r) => r.default || r));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.11.2_@unocss+reset@0.59.4_floating-vue@5.2.2_unocss@0.59.4_vite@5.2.10/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.11.2_@unocss+reset@0.59.4_floating-vue@5.2.2_unocss@0.59.4_vite@5.2.10/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { nuxtLinkDefaults as A, useRuntimeConfig as B, navigateTo as C, withTrailingSlash as D, withoutTrailingSlash as E, isStringNumber as F, hasOwn_1 as G, br as H, NOOP_1 as N, On as O, __nuxt_component_6 as _, useNamespace as a, isString_1 as b, isNumber as c, isFunction_1 as d, entry$1 as default, isArray_1 as e, isPlainObject_1 as f, debugWarn as g, __nuxt_component_8 as h, isUndefined as i, useId as j, isObject_1 as k, defineStore as l, capitalize_1 as m, toRawType_1 as n, isBoolean as o, useGetDerivedNamespace as p, useIdInjection as q, useZIndex as r, isElement as s, throwError as t, useHead as u, useRouter as v, hasProtocol as w, joinURL as x, parseURL as y, parseQuery as z };
