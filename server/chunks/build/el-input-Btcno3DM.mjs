import { defineComponent, useAttrs as useAttrs$1, useSlots, computed, shallowRef, ref, watch, nextTick, toRef, openBlock, createElementBlock, mergeProps, unref, createCommentVNode, Fragment, normalizeClass, renderSlot, createElementVNode, createBlock, withCtx, resolveDynamicComponent, withModifiers, createVNode, toDisplayString, normalizeStyle, getCurrentInstance } from 'vue';
import { b as buildProps, i as definePropType, v as iconPropType, m as mutable, V as ValidateComponentsMap, T as view_default, U as hide_default, s as isNil, u as useResizeObserver, E as ElIcon, l as circle_close_default, w as withInstall, O as fromPairs, I as useEventListener, _ as _export_sfc } from './base-TFdoAnCk.mjs';
import { a as useNamespace, g as debugWarn, N as NOOP_1, b as isString_1, d as isFunction_1 } from './server.mjs';
import { b as useSizeProp, d as useFormItem, e as useFormItemInputId, a as useFormSize, u as useFormDisabled } from './el-message-arfW-tYb.mjs';
...
export { CHANGE_EVENT as C, ElInput as E, UPDATE_MODEL_EVENT as U, isKorean as i, useFocusController as u };
//# sourceMappingURL=el-input-Btcno3DM.mjs.map
